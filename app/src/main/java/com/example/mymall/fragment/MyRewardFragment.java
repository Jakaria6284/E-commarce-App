...
import com.example.mymall.rewardAdapter;
...
public class MyRewardFragment extends Fragment {
    private RecyclerView rewardrecylerview;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        rewardrecylerview=view.findViewById(R.id.rewardrecyclerview);
        LinearLayoutManager layoutManager=new LinearLayoutManager(getContext());
        layoutManager.setOrientation(LinearLayoutManager.VERTICAL);
        rewardrecylerview.setLayoutManager(layoutManager);
        if(DBquires.rewardModelList.size()==0)
        {
            DBquires.loadrewards(getContext(),true,loading_dialog);
        }
        RewardAdapter=new rewardAdapter(DBquires.rewardModelList,false);
        rewardrecylerview.setAdapter(RewardAdapter);
